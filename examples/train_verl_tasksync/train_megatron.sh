...
# ==============================================================================
# [OOM defense] Mitigates CUDA memory fragmentation across multi-epoch runs.
# ==============================================================================
...
data_dir=${data_dir:-/ssddata/lihao/projects/task-sync/claude-sync-v4/opus}
...
# (see notes in aiic_recipe/train_megatron.sh).
# ==============================================================================
