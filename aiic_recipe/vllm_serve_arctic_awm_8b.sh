...
read -p "MODEL_PATH (默认 /mnt/public_02/lihao/ptc-checkpoints/baselines/Arctic-AWM-8B): " MODEL_PATH
MODEL_PATH="${MODEL_PATH:-/mnt/public_02/lihao/ptc-checkpoints/baselines/Arctic-AWM-8B}"
