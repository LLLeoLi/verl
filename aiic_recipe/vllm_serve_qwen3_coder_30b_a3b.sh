...
read -p "MODEL_PATH (默认 /mnt/public_02/lihao/ptc-checkpoints/Qwen3-Coder-30B-A3B-Instruct-sft/v0-20260628-061706/checkpoint-230): " MODEL_PATH
MODEL_PATH="${MODEL_PATH:-/mnt/public_02/lihao/ptc-checkpoints/Qwen3-Coder-30B-A3B-Instruct-sft/v0-20260628-061706/checkpoint-230}"
