...
read -p "MODEL_PATH (默认 /mnt/public_02/lihao/ptc-checkpoints/baselines/Toucan-7B): " MODEL_PATH
MODEL_PATH="${MODEL_PATH:-/mnt/public_02/lihao/ptc-checkpoints/baselines/Toucan-7B}"
